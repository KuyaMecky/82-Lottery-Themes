<div class="container">
    <div class="wdt-no-header-builder-content wdt-no-header-lottery_82_app">
        <div class="no-header">
            <div class="no-header-logo">
                <a href="<?php echo esc_url( home_url('/') );?>" title="<?php esc_attr(bloginfo('title')); ?>"><?php echo lottery_82_app_get_header_logo();?></a>
            </div>
            <?php
                $menu = false;
                if( has_nav_menu('main-menu') ) { ?>
                    <div class="no-header-menu wdt-header-menu" data-menu="dummy-menu">
                        <?php
                            ...
                            $menu = wp_nav_menu( apply_filters( 'lottery_82_app_default_menu_args', array(
                                ...
                                'link_before'     => '<span>',
                                'link_after'      => '</span>',
                                'walker'          => new _82lottery_Default_Header_Walker_Nav_Menu,
                                'echo'            => false
                            ) ) );

                            echo apply_filters( 'lottery_82_app_default_menu', $menu );
                            ...
                            if( $menu ) { ?>
                                <div class="mobile-nav-container" data-menu="dummy-menu">
                                    <a href="javascript:void(0);" class="menu-trigger menu-trigger-icon" data-menu="dummy-menu">
                                        <i></i>
                                        <span><?php esc_html_e('Menu', 'lottery_82_app'); ?></span>
                                    </a>

...
if( !class_exists( '_82lottery_Woo_Single_core' ) ) {

    class _82lottery_Woo_Single_core {
        ...
        function __construct() {
            ...
            // Enqueue CSS
                add_action( 'lottery_82_app_after_woo_css', array ( $this, 'after_woo_css' ), 10 );
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( lottery_82_app_is_file_in_theme( __FILE__ ) ) {
                    return LOTTERY_82_MODULE_DIR . '/woocommerce/single/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( lottery_82_app_is_file_in_theme( __FILE__ ) ) {
                    return LOTTERY_82_MODULE_URI . '/woocommerce/single/';
                } else {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'lottery_82_app_woo_single_page_settings', $this->settings );
        ...
        */
            function load_modules() {
                ...
                include_once LOTTERY_82_MODULE_DIR. '/woocommerce/single/includes/template.php';
                include_once LOTTERY_82_MODULE_DIR. '/woocommerce/single/includes/labels.php';
        ...
        */
            function after_woo_css() {
                ...
                if( is_product() ) {
                    wp_enqueue_style('lottery_82_app-woo-single-common', $this->module_dir_url() . 'assets/css/common.css');
                }
...
if( !function_exists('lottery_82_app_woo_single_core') ) {
	function lottery_82_app_woo_single_core() {
        $reflection = new ReflectionClass('_82lottery_Woo_Single_core');
        return $reflection->newInstanceWithoutConstructor();
	}
}

_82lottery_Woo_Single_core::instance();
...
if( !class_exists( '_82lottery_Shop_Single_Module_Upsell_Related' ) ) {

    class _82lottery_Shop_Single_Module_Upsell_Related {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( lottery_82_app_is_file_in_theme( __FILE__ ) ) {
                    return LOTTERY_82_MODULE_DIR . '/woocommerce/single/modules/upsell-and-related/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( lottery_82_app_is_file_in_theme( __FILE__ ) ) {
                    return LOTTERY_82_MODULE_URI . '/woocommerce/single/modules/upsell-and-related/';
                } else {
        ...
        */
            function woo_load_listing( $product_style_template, $product_style_custom_template ) {
                ...
                if( $product_style_template == 'predefined' ) {
                    $type_class_instance = 'lottery_82_app_woo_listing_type_'.$product_style_custom_template; // Type Class Instance
...
if( !function_exists('lottery_82_app_shop_single_module_upsell_related') ) {
	function lottery_82_app_shop_single_module_upsell_related() {
		return _82lottery_Shop_Single_Module_Upsell_Related::instance();
	}
}

lottery_82_app_shop_single_module_upsell_related();
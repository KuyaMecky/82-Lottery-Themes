...
if( !class_exists( '_82lottery_Woo_Listing_Option_Thumb_Element_Group' ) ) {

    class _82lottery_Woo_Listing_Option_Thumb_Element_Group extends _82lottery_Woo_Listing_Option_Core {
        ...
        function render_backend() {
            ...
            add_filter( 'lottery_82_app_woo_custom_product_template_thumb_options', array( $this, 'woo_custom_product_template_thumb_options'), 55, 1 );
        }
...
if( !function_exists('lottery_82_app_woo_listing_option_thumb_element_group') ) {
	function lottery_82_app_woo_listing_option_thumb_element_group() {
		return _82lottery_Woo_Listing_Option_Thumb_Element_Group::instance();
	}
}

lottery_82_app_woo_listing_option_thumb_element_group();
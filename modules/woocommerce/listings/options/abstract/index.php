...
abstract class _82lottery_Woo_Listing_Option_Core {
    ...
    */
        ...
        function module_dir_path() {
            ...
            if( lottery_82_app_is_file_in_theme( __FILE__ ) ) {
                return LOTTERY_82_MODULE_DIR . '/woocommerce/listings/options/';
            } else {
        ...
        function module_dir_url() {
            ...
            if( lottery_82_app_is_file_in_theme( __FILE__ ) ) {
                return LOTTERY_82_MODULE_URI . '/woocommerce/listings/options/';
            } else {
     ...
     */
        function render_frontend() {
            ...
            /* Options Class Names */
                add_filter( 'lottery_82_app_woo_listings_class', array( $this, 'woo_listings_class_load'), 10, 1 );
            ...
            if( $non_archive_listing ) {
                ...
                /* Options JS */
                    add_filter( 'lottery_82_app_woo_non_archive_js', array( $this, 'woo_listings_js_load'), 10, 1 );
                ...
                /* Options JS */
                    add_filter( 'lottery_82_app_woo_archive_js', array( $this, 'woo_listings_js_load'), 10, 1 );
            }
        ...
        function woo_listings_loop_prop() {
            ...
            if( in_array( 'html', $this->option_type ) ) {
                if( !empty ( $this->option_default_value ) ) {
                    ...
                    array_push( $lottery_82_app_shop_loop_prop, $this->option_slug );
                    wc_set_loop_prop('wdt-shop-loop-prop', $lottery_82_app_shop_loop_prop);
...
if( !function_exists('lottery_82_app_woo_listing_option_core') ) {
	function lottery_82_app_woo_listing_option_core() {
		return _82lottery_Woo_Listing_Option_Core::instance();
	}
}
...
function lottery_82_app_shop_woo_loop_product_thumb_content_setup($product_thumb_contents) {
	...
	if(!empty($product_thumb_contents)) {
		...
		foreach($product_thumb_contents as $product_thumb_content) {
			...
			add_action('lottery_82_app_woo_loop_product_thumb_content', 'lottery_82_app_shop_woo_loop_product_content_'.$product_thumb_content, $i, 1);
...
function lottery_82_app_shop_woo_loop_product_content_content_setup($product_content_contents) {
	...
	if(!empty($product_content_contents)) {
		...
		foreach($product_content_contents as $product_content_content) {
			...
			add_action('lottery_82_app_woo_loop_product_content_content', 'lottery_82_app_shop_woo_loop_product_content_'.$product_content_content, $i, 1);
...
if( ! function_exists( 'lottery_82_app_shop_woo_loop_product_content_title' ) ) {

	function lottery_82_app_shop_woo_loop_product_content_title() {

		global $product;
		echo '<div class="product-title"><h5><a href="'.esc_url($product->get_permalink()).'">'.lottery_82_app_html_output($product->get_name()).'</a></h5></div>';
...
if( ! function_exists( 'lottery_82_app_shop_woo_loop_product_content_excerpt' ) ) {

	function lottery_82_app_shop_woo_loop_product_content_excerpt() {

		global $product;
		if($product->get_short_description() != '') {
			echo '<div class="product-short-description">'.lottery_82_app_html_output($product->get_short_description()).'</div>';
		}
...
if( ! function_exists( 'lottery_82_app_shop_woo_loop_product_content_rating' ) ) {

	function lottery_82_app_shop_woo_loop_product_content_rating() {
		...
		if(wc_get_rating_html( $product->get_average_rating() ) != '') {
            ...
            $rating = 0;
            $label = sprintf( esc_html__( 'Rated %s out of 5', 'lottery_82_app' ), $rating );
...
if( ! function_exists( 'lottery_82_app_shop_woo_loop_product_content_category' ) ) {

	function lottery_82_app_shop_woo_loop_product_content_category() {
...
if( ! function_exists( 'lottery_82_app_shop_woo_loop_product_content_price' ) ) {

	function lottery_82_app_shop_woo_loop_product_content_price() {
...
if( ! function_exists( 'lottery_82_app_shop_woo_loop_product_content_button_element' ) ) {

	function lottery_82_app_shop_woo_loop_product_content_button_element($location) {
		...
		if($product_buttonelement_button) {
			...
			if($product_buttonelement_button == 'cart-with-quantity') {
				...
				if ( $product && $product->is_type( 'simple' ) ) {
					do_action( 'lottery_82_app_woo_loop_product_button_elements_cart_with_quantity' );
				} else {
					echo '<div class="product-buttons-wrapper product-button">';
						echo '<div class="wc_inline_buttons">';
							do_action( 'lottery_82_app_woo_loop_product_button_elements_cart' );
						echo '</div>';
					echo '</div>';
				}
			} else {
				echo '<div class="product-buttons-wrapper product-button">';
					echo '<div class="wc_inline_buttons">';
						...
						if($product_buttonelement_button == 'cart') {
							...
							do_action( 'lottery_82_app_woo_loop_product_button_elements_wishlist' );
						} else if($product_buttonelement_button == 'compare') {
							do_action( 'lottery_82_app_woo_loop_product_button_elements_compare' );
						} else if($product_buttonelement_button == 'quickview') {
							do_action( 'lottery_82_app_woo_loop_product_button_elements_quickview' );
						}
...
if( ! function_exists( 'lottery_82_app_shop_woo_loop_product_content_countdown' ) ) {

	function lottery_82_app_shop_woo_loop_product_content_countdown() {

		ob_start();
		lottery_82_app_shop_products_sale_countdown_timer();
		$woocommerce_template_countdown = ob_get_clean();
		$countdown = $woocommerce_template_countdown;

		if($countdown != '') {
            if( function_exists('lottery_82_app_shop_single_module_count_down_timer') ) {
                wp_enqueue_style( 'wdt-shop-coundown-timer',
                    lottery_82_app_shop_single_module_count_down_timer()->module_dir_url() . 'assets/css/style.css',
                    array()
                );
                wp_enqueue_script( 'jquery-downcount',
                    lottery_82_app_shop_single_module_count_down_timer()->module_dir_url() . 'assets/js/jquery.downcount.js',
                    array( 'jquery' ),
                    false,
                    true
                );
                wp_enqueue_script( 'wdt-shop-coundown-timer',
                    lottery_82_app_shop_single_module_count_down_timer()->module_dir_url() . 'assets/js/scripts.js',
                    array( 'jquery' ),
                    false,
                    true
                );
                ...
                echo '<div class="product-countdown-wrapper">'.lottery_82_app_html_output($countdown).'</div>';
            }
		}
...
if( ! function_exists( 'lottery_82_app_shop_woo_loop_product_content_swatches' ) ) {

	function lottery_82_app_shop_woo_loop_product_content_swatches() {
...
if( ! function_exists( 'lottery_82_app_shop_woo_loop_product_content_product_notes' ) ) {

	function lottery_82_app_shop_woo_loop_product_content_product_notes() {
...
if( ! function_exists( 'lottery_82_app_shop_woo_loop_product_content_icons_group' ) ) {

	function lottery_82_app_shop_woo_loop_product_content_icons_group($location) {
...
if( ! function_exists( 'lottery_82_app_shop_woo_loop_product_content_separator' ) ) {

	function lottery_82_app_shop_woo_loop_product_content_separator() {
...
if( ! function_exists( 'lottery_82_app_shop_woo_loop_product_content_element_group' ) ) {

	function lottery_82_app_shop_woo_loop_product_content_element_group($location) {
		...
		if($product_element_group) {
			...
			echo '<div class="product-element-group-wrapper">';
				...
				if(in_array('title', $product_element_group)) {
					ob_start();
					lottery_82_app_shop_woo_loop_product_content_title();
					$title = ob_get_clean();
				}
				...
				if(in_array('price', $product_element_group)) {
					ob_start();
					lottery_82_app_shop_woo_loop_product_content_price();
					$price = ob_get_clean();
				}
				...
				if(in_array('category', $product_element_group)) {
					ob_start();
					lottery_82_app_shop_woo_loop_product_content_category();
				...
				if(in_array('button_element', $product_element_group)) {
					ob_start();
					lottery_82_app_shop_woo_loop_product_content_button_element($location);
				...
				if(in_array('icons_group', $product_element_group)) {
					ob_start();
					lottery_82_app_shop_woo_loop_product_content_icons_group($location);
				...
				if(in_array('excerpt', $product_element_group)) {
					ob_start();
					lottery_82_app_shop_woo_loop_product_content_excerpt();
				...
				if(in_array('rating', $product_element_group)) {
					ob_start();
					lottery_82_app_shop_woo_loop_product_content_rating();
					$rating = ob_get_clean();
				}
				...
				if(in_array('separator', $product_element_group)) {
					ob_start();
					lottery_82_app_shop_woo_loop_product_content_separator();
				...
				echo '<div class="product-element-group-items">';
					...
					$i = 1;
					foreach ($product_element_group as $key => $value) {
						echo lottery_82_app_html_output($$value);
...
if( ! function_exists( 'lottery_82_app_shop_after_shop_loop_quick_view' ) ) {

	function lottery_82_app_shop_after_shop_loop_quick_view($location) {
	...
	add_action( 'template_redirect', 'lottery_82_app_shop_after_shop_loop_quick_view' );
	add_action( 'admin_init', 'lottery_82_app_shop_after_shop_loop_quick_view' );

}

// Content Actions - Label InStock

if( ! function_exists( 'lottery_82_app_shop_woo_loop_product_content_label_instock' ) ) {

	function lottery_82_app_shop_woo_loop_product_content_label_instock() {

        global $product;
        if($product->is_in_stock()) {
            echo '<div class="product-labels"><span class="instock"><span>'.esc_html__('In Stock', 'lottery_82_app').'</span></span></div>';
        }

...
if( !class_exists( '_82lottery_Woo_Listing_Shop' ) ) {

    class _82lottery_Woo_Listing_Shop {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'lottery_82_app_woo_shop_page_default_settings', $this->settings );
...
if( !function_exists('lottery_82_app_woo_listing_shop') ) {
	function lottery_82_app_woo_listing_shop() {
		return _82lottery_Woo_Listing_Shop::instance();
	}
}

lottery_82_app_woo_listing_shop();
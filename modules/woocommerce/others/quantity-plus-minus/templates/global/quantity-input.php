...
if ( $max_value && $min_value === $max_value ) {
	...
	$label = ! empty( $args['product_name'] ) ? sprintf( esc_html__( '%s quantity', 'lottery_82_app' ), wp_strip_all_tags( $args['product_name'] ) ) : esc_html__( 'Quantity', 'lottery_82_app' );

	/* Customized script */

	$settings = lottery_82_app_woo_others()->woo_default_settings();
	extract($settings);
	...
	<div class="quantity <?php echo esc_attr($plusminus_class); ?>">
		...
		<input
			...
			title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'lottery_82_app' ); ?>"

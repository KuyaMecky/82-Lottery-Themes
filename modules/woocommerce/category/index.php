...
if( !class_exists( '_82lottery_Woo_Listing_Category' ) ) {

    class _82lottery_Woo_Listing_Category {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( lottery_82_app_is_file_in_theme( __FILE__ ) ) {
                    return LOTTERY_82_MODULE_DIR . '/woocommerce/category/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( lottery_82_app_is_file_in_theme( __FILE__ ) ) {
                    return LOTTERY_82_MODULE_URI . '/woocommerce/category/';
                } else {
        ...
        function woo_template_redirect() {
            ...
            if( is_product_category() ) {
                ...
                /* Define Sorter Settings */
                    add_filter( 'lottery_82_app_woo_sorter_settings', array( $this, 'woo_sorter_settings' ) );
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'lottery_82_app_woo_category_page_default_settings', $this->settings );
        ...
        */
            function woo_load_listing() {
                ...
                if( $this->settings['product_style_template'] == 'predefined' ) {
                    $type_class_instance = 'lottery_82_app_woo_listing_type_'.$this->settings['product_style_custom_template']; // Type Class Instance
                } else if( $this->settings['product_style_template'] == 'custom' ) {
                    $type_class_instance = 'lottery_82_app_woo_listing_type_custom'; // Type Class Instance
                }
                ...
                if ( function_exists( $type_class_instance ) ) {
                    ...
                    if( is_array ( $type_options ) && !empty ( $type_options ) ) {
                        foreach ( $type_options as $type_option_key => $type_option ) {
                            ...
                            $option_class_instance = 'lottery_82_app_woo_listing_option_'.$type_option_key;  // Option Class Instance
...
if( !function_exists('lottery_82_app_woo_listing_category') ) {
	function lottery_82_app_woo_listing_category() {
		return _82lottery_Woo_Listing_Category::instance();
	}
}

lottery_82_app_woo_listing_category();
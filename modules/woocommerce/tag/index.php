...
if( !class_exists( '_82lottery_Woo_Listing_Tag' ) ) {

    class _82lottery_Woo_Listing_Tag {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'lottery_82_app_woo_tag_page_default_settings', $this->settings );
...
if( !function_exists('lottery_82_app_woo_listing_tag') ) {
	function lottery_82_app_woo_listing_tag() {
		return _82lottery_Woo_Listing_Tag::instance();
	}
}

lottery_82_app_woo_listing_tag();
...
<div class="single-entry-likes-views">
	<div class="wdt-like-views">
        <div class="likes lottery_82_app_like_btn">
            ...
            <a href="#" data-postid="<?php echo esc_attr($post_ID); ?>" data-action="like">
                <span><?php
					...
					echo lottery_82_app_html_output($lc);
                ?></span>
            </a>
        </div>
        ...
        <div class="views">
            <i class="wdticon-eye"></i>
            	<span><?php
					...
					update_post_meta( $post_ID, '_lottery_82_app_post_settings', $post_meta );
					echo lottery_82_app_html_output($v);
            	?></span>
        </div>
	</div>

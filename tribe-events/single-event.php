...
<div id="tribe-events-content" class="tribe-events-single">
    ...
    <div class="wdt-events-meta-content">
        <p class="tribe-events-back">
            <a href="<?php echo esc_url( tribe_get_events_link() ); ?>"> <?php printf( '&laquo; ' . esc_html_x( 'All %s', '%s Events plural label', 'lottery_82_app' ), $events_label_plural ); ?></a>
        </p>

        <!-- Notices -->
        <?php tribe_the_notices() ?>

        <?php echo lottery_82_app_html_output($title); ?>
	...
	<div id="tribe-events-header" <?php tribe_events_the_header_attributes() ?>>
		<!-- Navigation -->
		<nav class="tribe-events-nav-pagination" aria-label="<?php printf( esc_html__( '%s Navigation', 'lottery_82_app' ), $events_label_singular ); ?>">
